...
const UserDashDisplay = () => {
    return (
        <div className='w-[100%] h-[800px] flex flex-row pt-[40px] px-[2rem] pb-[2rem] '>
            ...
            <div className=' pt-20 invisible lg:visible flex flex-row flex-auto gap-3 w-full '>
                <div className=' gap-3 '>
...
export default UserDashDisplay