    ...
    <div className='w-full px-5 lg:px-16 text-sm lg:text-md'>
      <div className='flex flex-row items-center justify-between'>
        <div className='flex flex-row items-center gap-2'>
          <p className='p-3 rounded-md font-bold bg-[#9e8c8c25] active:bg-[#9e8c8c75] cursor-pointer hover:bg-[#9e8c8c75]'>Trending</p>
          <p className='font-bold p-3 rounded-md bg-[#9e8c8c25] active:bg-[#9e8c8c75] cursor-pointer hover:bg-[#9e8c8c75]'>Top</p>
        </div>
      </div>
